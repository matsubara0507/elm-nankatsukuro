...
var _matsubara0507$elm_nankatsukurou$Main$viewRepo = function (repo) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('repo mini-repo-list-item'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('text-left mb-0'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
				...
				_0: A2(
					...
					},
					{
						...
						_0: _elm_lang$html$Html$text(
							_elm_lang$core$Basics$toString(repo.stars)),
						_1: {
							ctor: '::',
							_0: A2(
...
var _matsubara0507$elm_nankatsukurou$Main$count = function (_p0) {
...
var _matsubara0507$elm_nankatsukurou$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('text-center p-5'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Your Elm力 is ...'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('power'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							_elm_lang$core$Basics$toString(
								_matsubara0507$elm_nankatsukurou$Main$count(model.repos))),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('repos'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('boxed-group centered'),
								_1: {ctor: '[]'}
							}
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Your Elm Repositories'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('boxed-group-inner'),
										_1: {ctor: '[]'}
									},
									A2(_elm_lang$core$List$map, _matsubara0507$elm_nankatsukurou$Main$viewRepo, model.repos)),
								_1: {ctor: '[]'}
							}
						}),
					_1: {ctor: '[]'}
...
var _matsubara0507$elm_nankatsukurou$Main$Model = F3(
	function (a, b, c) {
		return {repos: a, user: b, message: c};
	});
var _matsubara0507$elm_nankatsukurou$Main$model = A3(
	_matsubara0507$elm_nankatsukurou$Main$Model,
	{ctor: '[]'},
	'',
	'');
var _matsubara0507$elm_nankatsukurou$Main$updateUser = F2(
	function (loc, moel) {
		return _elm_lang$core$Native_Utils.update(
			_matsubara0507$elm_nankatsukurou$Main$model,
			{
				user: A2(
					_elm_lang$core$Maybe$withDefault,
					'',
					A2(_evancz$url_parser$UrlParser$parseHash, _evancz$url_parser$UrlParser$string, loc))
			});
	});
var _matsubara0507$elm_nankatsukurou$Main$Repo = F3(
	function (a, b, c) {
		return {name: a, url: b, stars: c};
	});
var _matsubara0507$elm_nankatsukurou$Main$repoDecoder = A4(
	_elm_lang$core$Json_Decode$map3,
	_matsubara0507$elm_nankatsukurou$Main$Repo,
...
var _matsubara0507$elm_nankatsukurou$Main$SearchRepos = {ctor: 'SearchRepos'};
var _matsubara0507$elm_nankatsukurou$Main$ChangeUrl = function (a) {
	return {ctor: 'ChangeUrl', _0: a};
};
var _matsubara0507$elm_nankatsukurou$Main$Fetch = function (a) {
	return {ctor: 'Fetch', _0: a};
};
var _matsubara0507$elm_nankatsukurou$Main$searchReposWith = function (query) {
	var url = A2(_elm_lang$core$Basics_ops['++'], 'https://api.github.com/search/repositories?q=', query);
	var request = A2(
		...
		A2(
			...
			'items',
			_elm_lang$core$Json_Decode$list(_matsubara0507$elm_nankatsukurou$Main$repoDecoder)));
	return A2(_elm_lang$http$Http$send, _matsubara0507$elm_nankatsukurou$Main$Fetch, request);
};
var _matsubara0507$elm_nankatsukurou$Main$searchRepos = function (name) {
	return _elm_lang$core$Platform_Cmd$batch(
		{
			ctor: '::',
			_0: _matsubara0507$elm_nankatsukurou$Main$searchReposWith(
				A2(_elm_lang$core$Basics_ops['++'], 'language:elm+user:', name)),
			_1: {
				ctor: '::',
				_0: _matsubara0507$elm_nankatsukurou$Main$searchReposWith(
					A2(_elm_lang$core$Basics_ops['++'], 'topic:elm+user:', name)),
				_1: {ctor: '[]'}
			}
		});
};
	...
	function (msg, model) {
		...
		while (true) {
			...
			switch (_p2.ctor) {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									repos: A2(
										...
										A2(_elm_lang$core$Basics_ops['++'], _p2._0._0, model.repos))
								}),
				...
				case 'ChangeUrl':
					var _v1 = _matsubara0507$elm_nankatsukurou$Main$SearchRepos,
						_v2 = A2(_matsubara0507$elm_nankatsukurou$Main$updateUser, _p2._0, model);
					msg = _v1;
					model = _v2;
					continue update;
				default:
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _matsubara0507$elm_nankatsukurou$Main$searchRepos(model.user)
					};
			}
		}
	});
var _matsubara0507$elm_nankatsukurou$Main$init = F2(
	function (model, loc) {
		return A2(
			_matsubara0507$elm_nankatsukurou$Main$update,
			_matsubara0507$elm_nankatsukurou$Main$SearchRepos,
			A2(_matsubara0507$elm_nankatsukurou$Main$updateUser, loc, model));
	});
var _matsubara0507$elm_nankatsukurou$Main$main = A2(
	_elm_lang$navigation$Navigation$program,
	_matsubara0507$elm_nankatsukurou$Main$ChangeUrl,
	{
		init: _matsubara0507$elm_nankatsukurou$Main$init(_matsubara0507$elm_nankatsukurou$Main$model),
