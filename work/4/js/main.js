...
var _matsubara0507$elm_nankatsukurou$Main$updatePushed = F2(
	function (key, model) {
		return _elm_lang$core$Native_Utils.eq(
			_elm_lang$core$Tuple$first(model.pushed),
			_elm_lang$core$Maybe$Just(key)) ? {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Maybe$Just(key),
			_1: A2(
				_elm_lang$core$Basics_ops['%'],
				_elm_lang$core$Tuple$second(model.pushed) + 1,
				_elm_lang$core$List$length(key.data))
		} : {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Maybe$Just(key),
			_1: 0
...
var _matsubara0507$elm_nankatsukurou$Main$updateText = function (model) {
	return A2(_elm_lang$core$Basics_ops['++'], model.text, model.cache);
};
var _matsubara0507$elm_nankatsukurou$Main$updateCache = F2(
	function (key, model) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			'',
			A2(
				...
				_elm_lang$core$Tuple$second(model.pushed),
				key.data));
	});
	...
	function (msg, model) {
		...
		if (_p0.ctor === 'Push') {
			...
			var model_ = _elm_lang$core$Native_Utils.update(
				model,
				{
					pushed: A2(_matsubara0507$elm_nankatsukurou$Main$updatePushed, _p1, model)
				});
			return _elm_lang$core$Native_Utils.eq(
				_elm_lang$core$Tuple$first(model.pushed),
				...
				_0: _elm_lang$core$Native_Utils.update(
					model_,
					{
						cache: A2(_matsubara0507$elm_nankatsukurou$Main$updateCache, _p1, model_)
					}),
				...
				_0: _elm_lang$core$Native_Utils.update(
					model_,
					{
						text: _matsubara0507$elm_nankatsukurou$Main$updateText(model_),
						cache: A2(_matsubara0507$elm_nankatsukurou$Main$updateCache, _p1, model_)
					}),
				_1: _elm_lang$core$Platform_Cmd$none
			};
			...
			return {
				...
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{
						text: _matsubara0507$elm_nankatsukurou$Main$updateText(model),
						pushed: {ctor: '_Tuple2', _0: _elm_lang$core$Maybe$Nothing, _1: -1},
						cache: ''
					}),
				_1: _elm_lang$core$Platform_Cmd$none
			};
...
var _matsubara0507$elm_nankatsukurou$Main$Key = F2(
	function (a, b) {
		return {view: a, data: b};
	});
var _matsubara0507$elm_nankatsukurou$Main$keys = {
	ctor: '::',
	_0: A2(
		_matsubara0507$elm_nankatsukurou$Main$Key,
		'1 あ',
		{
			ctor: '::',
			_0: 'あ',
...
var _matsubara0507$elm_nankatsukurou$Main$Model = F3(
	function (a, b, c) {
		return {text: a, pushed: b, cache: c};
	});
var _matsubara0507$elm_nankatsukurou$Main$init = {
	...
	_0: A3(
		...
		'',
		{ctor: '_Tuple2', _0: _elm_lang$core$Maybe$Nothing, _1: -1},
		''),
	_1: _elm_lang$core$Platform_Cmd$none
};
var _matsubara0507$elm_nankatsukurou$Main$Return = {ctor: 'Return'};
var _matsubara0507$elm_nankatsukurou$Main$returnButton = A2(
	_elm_lang$html$Html$a,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('return button'),
		_1: {
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$type_('button'),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(_matsubara0507$elm_nankatsukurou$Main$Return),
				_1: {ctor: '[]'}
			}
		}
	},
...
var _matsubara0507$elm_nankatsukurou$Main$Push = function (a) {
	return {ctor: 'Push', _0: a};
};
var _matsubara0507$elm_nankatsukurou$Main$keyView = function (key) {
	return A2(
		_elm_lang$html$Html$a,
		{
			ctor: '::',
			...
			_1: {
				...
				_1: {
					...
					_0: _elm_lang$html$Html_Events$onClick(
						_matsubara0507$elm_nankatsukurou$Main$Push(key)),
					_1: {ctor: '[]'}
				}
			}
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(key.view),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
								...
								_1: {
									...
									_1: {
										...
										_0: _elm_lang$html$Html_Attributes$value(
											A2(_elm_lang$core$Basics_ops['++'], model.text, model.cache)),
										_1: {ctor: '[]'}
									}
								}
							}
			...
			_1: {
				...
				_0: A2(
					...
					A2(
						...
						_matsubara0507$elm_nankatsukurou$Main$returnButton,
						A2(_elm_lang$core$List$map, _matsubara0507$elm_nankatsukurou$Main$keyView, _matsubara0507$elm_nankatsukurou$Main$keys))),
				_1: {ctor: '[]'}
			}
		});
};
